...
public class SwimlaneLogging {
	...
	@Before("execution(* com.revature.Project2.service.SwimlaneService.*(..))")
	...
	@After("execution(* com.revature.Project2.service.SwimlaneService.*(..))")
