...
@Aspect
@Component 
//@Configuration // different examples used this
public class BoardLogging {
	...
	@Before("execution(* com.revature.Project2.service.BoardService.*(..))")
	...
	@After("execution(* com.revature.Project2.service.BoardService.*(..))")
